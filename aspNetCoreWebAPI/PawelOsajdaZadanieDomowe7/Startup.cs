...
using PawelOsajdaZadanieDomowe7.Repositories;
...
namespace PawelOsajdaZadanieDomowe7
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ILaptopsService, LaptopService>();
            services.AddScoped<ILaptopsRepository, LaptopsRepository>();
